...
const img/pic3.jpg = document.createElement('figure');
filename.appendChild(title);
filename.appendChild(title);

const caption9 = document.createElement('h2');
caption9.innerHTML = 'Article header 2';

const header = document.createElement('header');
header.appendChild(title);

const description = document.createElement('p');
description.innerHTML = 'Here is some text. Here is some text. Here is some text.';
